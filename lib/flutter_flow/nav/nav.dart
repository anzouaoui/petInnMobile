...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PopularPageWidget.routeName,
          path: PopularPageWidget.routePath,
          builder: (context, params) => PopularPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : NavBarPage(
                  initialPage: 'MyBookingPage',
                  page: MyBookingPageWidget(),
                ),
        ),
        FFRoute(
          name: RefundMethodPageWidget.routeName,
          path: RefundMethodPageWidget.routePath,
          builder: (context, params) => RefundMethodPageWidget(),
        ),
        FFRoute(
          name: PropertyPageWidget.routeName,
          path: PropertyPageWidget.routePath,
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Design_sans_titre_(1).png',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
