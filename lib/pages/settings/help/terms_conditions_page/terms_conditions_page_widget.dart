                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'b589fq51' /* Lorem ipsum dolor sit amet, co... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'rtv4x73z' /* Accessing the Service */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleLarge
                                  .override(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'g3tokoy9' /* Sagittis vitae et leo duis ut ... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
