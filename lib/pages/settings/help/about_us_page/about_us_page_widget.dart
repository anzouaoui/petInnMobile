              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        'tcixrgou' /* We focus on the Digital Econom... */,
                      ),
                      style:
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '2nbfevex' /* Lorem ipsum dolor sit amet, co... */,
                      ),
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '4aq2rxjz' /* Sagittis vitae et leo duis ut ... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.quicksand(
                              fontWeight: FlutterFlowTheme.of(context)
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'zu6snxw0' /* Sagittis eu volutpat odio faci... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.quicksand(
                              fontWeight: FlutterFlowTheme.of(context)
