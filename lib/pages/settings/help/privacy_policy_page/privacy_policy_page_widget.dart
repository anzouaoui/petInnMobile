                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '8ou90j78' /* Lorem ipsum dolor sit amet, co... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'wiolzjbu' /* Accessing the Service */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .titleLarge
                                  .override(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'yiplk4c7' /* Sagittis vitae et leo duis ut ... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
